...
export class RegisterComponent {
  ...
  @Input() btnName: string = "Créer un compte";
  ...
  register(){
    ...
    this.isLoader = true
          ...
          this.authService.inscription(this.email,this.username,this.password,this.nom,this.prenom,this.dateNaissance,this.numeroRue,this.nomRue,this.adresse,this.sexe,this.telephone).subscribe(
            (response: any)=>{
