...
@Component({
  selector: 'app-logement-partenaire',
  templateUrl: './logement-partenaire.component.html',
  styleUrls: ['./logement-partenaire.component.css']
})
export class LogementPartenaireComponent implements OnInit{
  ...
  getdetailLogement(id: string){
    this.router.navigate([`/client-partenaire/detail-logements/${id}`])
  }
